...
function NavBar() {
    return (
        <>
            <div className="w-full mx-auto px-6 py-6 md:px-0  border border-green-600">
                <nav className="w-full flex items-center md:justify-center text-gray-500 border border-green-700 md:mx-auto">
                    ...
                    <div className="w-42 hidden h-10 md:flex space-x-4 border ml-4 items-center border-red-600">
                        <div className=''>
                            <svg xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                    ...
                    <div className="relative ml-3 border border-red-600 text-sm ">
                    ...
                    <button className="w-25 h-8 hidden py-1 px-2 md:flex md:m-4 items-center border border-gray-700 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            width="18"
                            height="18"
                            viewBox="0 0 24 24"
                    ...
                    <div className="hidden md:ml-14 md:flex md:px-4 md:items-center  border border-red-600 ">
                        <Link href="/" className="text-gray-400 hover:text-white">Login</Link>
                        <button className="bg-blue-600  ml-2 text-sm px-6 py-3 rounded-3xl text-white">Sign Up</button>
                    </div>
                    <div className='block md:hidden ml-96'>
                        <svg xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
